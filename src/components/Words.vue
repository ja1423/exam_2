...
<div class="flex  mt-36 justify-between">
    <h1 class="font-semibold text-2xl max-w-[300px] text-[#454545]">Производство светильников</h1>
    <p class="max-w-[700px] text-[#454545]">
