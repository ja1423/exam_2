    ...
    >
      <div class="container md:mt-4 sticky z-0">
        <div class="flex md:justify-between items-center gap-4">
          ...
          <div
            class="flex max-md:hidden border rounded-full bg-[#454545] items-center px-7 gap-4 py-3 mx-8"
          >
            <svg
              class="mt-2"
              width="25"
          ...
          <div
            class="flex max-md:hidden gap-4 h-full items-center relative w-full"
          >
            <input
              type="text"
              placeholder="Поиск по товарам"
              class="border-2 border-gray-300 pl-8 pr-10 py-[14px] rounded-full w-full h-full focus:outline-none"
            />
            <img
              class="absolute top-1/2 -translate-y-1/2 right-0 -translate-x-3/4 z-10"
              src="/public/poisk.svg"
              alt=""
            />
          </div>
          ...
          <div class="flex items-center md:gap-6 gap-2">
            <div>
              <img class="mx-auto hover max-md:w-full" src="/public/heart.svg" alt="" />
              <p class="max-md:hidden">Избранное</p>
            </div>
            ...
            <div>
              ...
              <p class="max-md:hidden">Корзина</p>
            </div>
          </div>
        </div>
        <div
          class="flex gap-4 md:hidden mt-4 w-full h-full items-center relative"
        >
          <input
            type="text"
            placeholder="Поиск по товарам"
            class="border-2 border-gray-300 w-full pl-8 pr-10 py-[14px] rounded-full h-full focus:outline-none"
          />
          <img
            class="absolute top-1/2 -translate-y-1/2 right-0 -translate-x-3/4 z-10"
            src="/public/poisk.svg"
      ...
      <div class="bg-white md:p-8 rounded-2xl shadow-lg relative md:px-32 px-12 py-20">
        ...
        <form @submit.prevent="handleSubmit">
          <input
            type="text"
            placeholder="ФИО"
            class="border-2 border-gray-300 w-full p-3 mb-4 rounded-full"
            required
          />
          <input
            type="text"
          ...
          <button
            type="submit"
            class="w-full bg-black text-white p-3 rounded-full"
          >
            Отправить
          </button>
        </form>
